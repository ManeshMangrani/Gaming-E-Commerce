...
$query = "Insert into forum(subject,des,username) values('$sb','$dc','$nm')";
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <a href="index.php?logout=1" style="margin-left: 500px"><?php
         ...
         <div class="main-container col1-layout">
            <div class="main">
             ...
             <div class="form-group">
             <input type="text" name="sb" placeholder="Your Subject" >
          </div>


              <div class="form-group">
         <input type="text" name="dc" placeholder="text">
          </div>
  ...
  include 'config.php' ;
                               ...
                               $query = "select * from forum order by for_id desc" ;
...
<p> <b>Posted by: </b><?php echo $row['username'] ?> </p>
 <p><b>Subject:  <?php echo $row['subject']  ?></b></p>
