...
float: right;
font-size: 16px;"> Last access :  8th November, 2017 &nbsp; <a href="index1.php?logout=1" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>
           <!-- /. NAV TOP  -->
        ...
        <div id="page-wrapper" >
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Admin Dashboard</h2>
                        <h5>Welcome To web Gruoup , Love to see you back. </h5>
                    </div>
                </div>
                 <!-- /. ROW  -->
                  <hr />
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">Gifts Cards</p>
                    <p class="text-muted"></p>
                </div>
             </div>
		     </div>
