                              ...
                              <div class="header-link-right">
                                 <div class="block-account-cusomer block-action">
                                    <div class="toplink-cus cus-btn">
                                       ...
                                       <a class="login-btn" data-toggle="modal" data-target="#modal-login" title="Login">Login                                            <i class="fa fa-user-circle" aria-hidden="true"></i>
                                       </a>
                                    </div>
                                 </div>
                              </div>
                              <div class="dropdown-block currency-block">
                                 <div class="currency-switcher">
                                    ...
                                    <ul class="dropdown-list">
                                       <li><a href="#"><i class="fa fa-curr fa-eur"></i> EUR</a></li>
                                       <li><a href="#"><i class="fa fa-curr fa-gbp"></i> GBP</a></li>
                                       <li class="current"><i class="fa fa-curr fa-usd"></i> USD</li>
                                    </ul>
                                 </div>
                              </div>
                           </div>
                                          ...
                                          <div class="row">
                                             <div class="col-lg-12 col-md-12">
                                                <div class="nav-container">
                                                   <ul id="nav">
                                                      <li  class=""><a href="games.html">
                                                         <span>Games</span></a>
                                                      </li>
                                                      <li  class=""><a href="gift-cards.html" >
                                                         <span>Bundle Games</span></a>
                                                      </li>
                                                      <li >
                                                         <a href="#" >
                  ...
                  <div class="gift-inner-main">
                     ...
                     <div style="width: 100%;position: relative;display: inline-block;">
                        <div class="gift-card-summary">
                           Displaying <b>1</b> to <b>15</b> (of <b>291</b> results)
                        </div>
                        <div class="gift-card-sort-btn" >
                           Sort by&nbsp;
                           <div class="btn-group">
                              <button class="btn btn-default" type="button" data-order="0" value="0">Best Selling</button>
                                ...
                                <div class="md-20">
                                    <div class="product-tab">
                                        ...
                                        <div class="product-description">
                                            <p>USD15 Amazon Gift Card (US) Discount </p>
                                        </div>
                                        <div class="product-detail-btn">
                                            <a href="#">More details</a>
                                        </div>
                                        <div class="gift-amount">
                                            <div class="gift-price">US $105.00</div>
