...
if (isset($_POST['submit1']))
{
  ...
  mysqli_query($link,"insert into customer values('','$_POST[Name]','$_POST[password]','$_POST[email]','$_POST[Address]','$_POST[city]','$_POST[pincode]','$_POST[contact]')")
  ?>
...
<div class="form-actions">
      <input type="submit" name="submit1" value="Register"  class="btn btn-primary btn-sx"/>
</div>
        </form>
                  </div>
               </div>
